...
source_updated_at: '2026-08-12T11:28:53+09:00'
note_url: https://note.com/shou_devlog/n/nc48144f38ccb
...
この記事は、**AI駆動開発の話についていけていない**と感じているすべての人に向けて書いています。具体的には、次の2種類の方です。
...
後者の方へ先にお伝えしておきます。**この記事はコードが書けなくても読めます。** 出てくるのは用語の意味と、それが生まれた理由だけで、設定ファイルの書き方は一行も出てきません。

むしろ、いま企画や意思決定をする立場の人ほど、ここを押さえる価値が上がっていると思っています。「この機能、AIにやらせたら1日で終わりますよね？」が正しいのか無茶なのかは、**AIエージェントに何ができて何ができないか**を知らないと判断できません。そしてその境界線は、この記事で扱う用語そのものです。

最近、恐れ多くも同僚や知人にAI駆動開発についてお話しする機会が増えました。そういう人と話していると、職種を問わず、だいたい同じところで止まっています。
...
なお、Claude Code は「エンジニアがターミナルで使う道具」ですが、この記事で説明するのは**その中の考え方**なので、使ったことがなくてもまったく問題ありません。
...
**👉 後編はこちら**（Qiita 版です。note 版も近日公開予定）
...
- この記事の原文（Qiita）: https://qiita.com/shou-dev19/items/e1583af614a573e4b245
